 ...
 */
final class Version20230202100339 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_publication (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE category_publication_categories ADD CONSTRAINT FK_29CDC635A21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE category_publication_categories ADD CONSTRAINT FK_29CDC635D9A2549A FOREIGN KEY (category_publication_id) REFERENCES category_publication (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE category_publication_publications ADD CONSTRAINT FK_D0D589F3AFFB3979 FOREIGN KEY (publications_id) REFERENCES publications (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE category_publication_publications ADD CONSTRAINT FK_D0D589F3D9A2549A FOREIGN KEY (category_publication_id) REFERENCES category_publication (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
